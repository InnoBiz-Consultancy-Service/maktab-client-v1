...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  function Textarea({ label, error, icon, className, id, ...props }, ref) {
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          {icon && (
            <span className="pointer-events-none absolute top-4 left-3.5 text-ink-soft">
              {icon}
            </span>
          )}
          ...
          <textarea
            ...
            id={textareaId}
            className={cn(
              "min-h-[120px] w-full resize-y rounded-sm border bg-cream-50 px-4 py-2.5 text-[15px] text-night-900",
